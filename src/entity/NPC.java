...
public class NPC extends Entity {
	...
	/**
	 * Update-Methode des NPC. Hier wird das Wippen des Kopfs des NPC veranlasst und im Dialogfall dieser ermï¿½glicht.
	 */
	public void update() {
		frameCounter++;
		if (frameCounter >= 30) {
	 ...
	 * Game-Status wird geï¿½ndert und boolean ichRede auf true gesetzt.
	 */
