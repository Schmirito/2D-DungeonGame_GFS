...
public class Ghost extends Entity {
	...
	int zaeler = 0;
	/**
	 * Konstruktor f�r Ghost. Geht bidirektionale Beziehung mit GamePanel ein. Weltposition und weitere Variablen wie die der Hitbox werden initialisiert.
	...
	/**
	 * Das Bewegungsverhalten eines Geist-Objekts wird hier ausgef�hrt. Gehen zum Spieler und Schlagen diesen, keine Feld-Kollision.
	 */
	public void update() {
