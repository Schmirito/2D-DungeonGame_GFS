...
public class FeldManager {
	...
	// Etwas unsch�n gel��t, aber funktioniert.
	...
	/**
	 * Konstruktor f�r Feldmanager. Manche Variablen werden initialisiert, getFeldBild() wird aufgerufen.
	 * @param gp GamePanel wird f�r Bidirektionale Assoziation �bergeben.
	 */
	...
	/**Es wird eine mapNr nach einem bestimmten Vorgang ausgew�hlt, welche f�r einen Dateipfad zu einer .txt-Datei, gespeichert im Array mapAuswahl[], steht.
	 * Daraufhin wird die (neu) ausgew�hlte Map aus der .txt-Datei in das Integer Array mapFeldNr[][] geladen.
	 */
	public void loadMap() {
		switch (mapNr) {
	...
	/**Die Felder werden unter einem Dateipfad gesucht, skaliert und kollisionen hinzugef�gt.
	 * @param index	Die Nummer, welche in der .txt-Dateit f�r dieses Feld steht.
	 * @param bildName Der Bildname ohne weiteren Pfad.
	 * @param kollision Ob Kollison mit diesem Block m�glich ist.
	 */
	...
	/**
	 * Gibt den Index f�r das Feld mit dem �bergebenen Bildnamen zur�ck.
	 * @param bildName Der Bildname des Felds, f�r welches der Index gesucht werden soll.
	...
	/**Die Bilder der jeweiligen Felder werden an der ihnen jeweils zugeh�rigen Position in der Welt, wenn sich diese auf dem Bildschirm befindet, gezeichnet.
