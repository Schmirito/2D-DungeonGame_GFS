...
public class Platzierer {
	...
	public void setzeEntity() {
		...
		gp.entities[1] = new Zombie(gp, 28 * gp.feldGroeﬂe, 20 * gp.feldGroeﬂe);
		gp.entities[2] = new Zombie(gp, 23 * gp.feldGroeﬂe, 10 * gp.feldGroeﬂe);
		gp.entities[3] = new Zombie(gp, 27 * gp.feldGroeﬂe, 5 * gp.feldGroeﬂe);
		...
		gp.entities[6] = new Zombie(gp, 25 * gp.feldGroeﬂe, 23 * gp.feldGroeﬂe);
